 ...
 * decision tree. For more information, see<br/> <br/> Ross Quinlan (1993).
	...
	public Capabilities getCapabilities()
	{
		...
		try
		{
			if (!m_reducedErrorPruning)
				result = new C45PruneableClassifierTree(null, !m_unpruned,
						m_CF, m_subtreeRaising, !m_noCleanup).getCapabilities();
			else
				result = new PruneableClassifierTree(null, !m_unpruned,
						m_numFolds, !m_noCleanup, m_Seed).getCapabilities();
		}
		catch (Exception e)
		{
