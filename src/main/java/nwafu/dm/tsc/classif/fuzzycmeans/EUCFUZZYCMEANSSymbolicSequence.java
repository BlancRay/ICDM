 ...
 ******************************************************************************/
package nwafu.dm.tsc.classif.fuzzycmeans;
...
import nwafu.dm.tsc.classif.kmeans.EUCKMeansSymbolicSequence;

public class EUCFUZZYCMEANSSymbolicSequence {
	...
	public EUCFUZZYCMEANSSymbolicSequence(int nbClusters, ArrayList<Sequence> data, int dataAttributes) {
