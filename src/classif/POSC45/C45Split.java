...
public class C45Split extends ClassifierSplitModel
{
	...
	{
		//Out.println("ʹ��C45split��buildClassifier����");
		
		//Out.println("ATTRIBUTE : " + trainInstances.attribute(m_attIndex));
		...
		if (trainInstances.attribute(m_attIndex).isNominal())
		{
			...
			//Out.println("�����������ɢ�Ļ�����ʹ��handleEnumeratedAttribute����");
		...
		else
		{
			...
			//Out.println("��������������Ļ�����ʹ��handleEnumeratedAttribute����");
			...
			throws Exception
	{
		...
		m_distribution = new Distribution(m_complexityIndex, trainInstances
				.numClasses());
	...
	public final String sourceExpression(int index, Instances data)
	{
		...
		if (data.attribute(m_attIndex).isNominal())
		{
			...
			expr.append(".equals(\"").append(
					data.attribute(m_attIndex).value(index)).append("\")");
		}
		else
		{
