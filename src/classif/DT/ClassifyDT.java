...
public class ClassifyDT
  ...
  public Capabilities getCapabilities() {
    ...
    try {
        result = new C45tree(null, !m_unpruned, m_CF, m_subtreeRaising, !m_noCleanup).getCapabilities();
    }
    catch (Exception e) {
   ...
   */
	public void buildClassifier(Instances instances) throws Exception {
		...
		root = new C45tree(modSelection, !m_unpruned, m_CF, m_subtreeRaising, !m_noCleanup);
  ...
  public final double [] distributionForInstance(Instance instance) 
    ...
    return root.distributionForInstance(instance, m_useLaplace);
  }
  ...
  public static void main(String [] argv){
    runClassifier(new ClassifyDT(), argv);
  }
}
